...
public class ClassroomAdapter extends RecyclerView.Adapter<MyPKAdapter.ViewHolder> {
...
//    }
    ...
    public List<ClassroomBean> datas = null;
//    private ItemClickCallBack clickCallBack;

    public ClassroomAdapter(List<ClassroomBean> datas) {
        this.datas = datas;
    }
    ...
    public MyPKAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_classroom, viewGroup, false);
