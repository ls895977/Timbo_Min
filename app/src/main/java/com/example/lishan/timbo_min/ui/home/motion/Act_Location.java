...
import com.example.lishan.timbo_min.common.MyApplication;
import com.example.lishan.timbo_min.map.utils.BitmapUtil;
import com.example.lishan.timbo_min.map.utils.CommonUtil;
import com.example.lishan.timbo_min.map.utils.Constants;
import com.example.lishan.timbo_min.map.utils.CurrentLocation;
import com.example.lishan.timbo_min.map.utils.MapUtil;
import com.example.lishan.timbo_min.map.utils.ViewUtil;
import com.example.lishan.timbo_min.receiver.TrackReceiver;
...
public class Act_Location extends BaseAct {
    ...
    public void initView() {
        ...
        setOnClickListener(R.id.location_back);
        setOnClickListener(R.id.location_click1s);
        BitmapUtil.init();
        initListener();
    ...
    private void initListener() {
        ...
        traceListener = new OnTraceListener() {
            ...
            public void onBindServiceCallback(int errorNo, String message) {
                viewUtil.showToast(Act_Location.this,
                        String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));

                com.lykj.aextreme.afinal.utils.Debug.e("aa----" + String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));
            }
            ...
            public void onStartTraceCallback(int errorNo, String message) {
                ...
                com.lykj.aextreme.afinal.utils.Debug.e("aa--1111--" + String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));
            }
            ...
            public void onStopTraceCallback(int errorNo, String message) {
                ...
                com.lykj.aextreme.afinal.utils.Debug.e("aa--222--" + String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));
            }
            ...
            public void onStartGatherCallback(int errorNo, String message) {
                ...
                com.lykj.aextreme.afinal.utils.Debug.e("aa--333--" + String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));
            }
            ...
            public void onStopGatherCallback(int errorNo, String message) {
                ...
                com.lykj.aextreme.afinal.utils.Debug.e("aa--444--" + String.format("onBindServiceCallback, errorNo:%d, message:%s ", errorNo, message));
