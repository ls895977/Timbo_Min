...
//    }
    ...
    public List<IntegralBean> datas = null;
//    private ItemClickCallBack clickCallBack;

    public IntegralAdapter(List<IntegralBean> datas) {
        this.datas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_integral, viewGroup, false);
