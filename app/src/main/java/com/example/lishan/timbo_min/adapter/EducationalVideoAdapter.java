...
public class EducationalVideoAdapter extends RecyclerView.Adapter<EducationalVideoAdapter.MyViewHolder> {
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        EducationalVideoAdapter.MyViewHolder viewHolder = new EducationalVideoAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_educationalvideo, parent, false));
        return viewHolder;
    }
