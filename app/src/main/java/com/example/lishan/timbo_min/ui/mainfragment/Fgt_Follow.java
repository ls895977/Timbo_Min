...
public class Fgt_Follow extends BaseFgt {
    ...
    public void initData() {
        myWebView = getView(R.id.follow_webview);
        myWebView.loadUrl("http://wz.kulehu.com/h5/my_attention.html");
