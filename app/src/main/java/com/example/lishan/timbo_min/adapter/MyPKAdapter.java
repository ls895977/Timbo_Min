...
public class MyPKAdapter extends RecyclerView.Adapter<MyPKAdapter.ViewHolder> {
...
//    }
    ...
    public List<MyPKBean> datas = null;
//    private ItemClickCallBack clickCallBack;

    public MyPKAdapter(List<MyPKBean> datas) {
        this.datas = datas;
    }
    ...
    public MyPKAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_mypk, viewGroup, false);
